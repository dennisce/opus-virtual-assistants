...
export const pt = {
    ...
    parallaxHero: {
      ...
      startNow: "Começar Agora",
      tryAssistant: {
        title: "Teste nosso Assistente",
        description: "Experimente agora mesmo como nosso assistente pode transformar seu atendimento!",
        button: "Testar Assistente",
    ...
    conversion: {
      ...
      subtitle: "Empresas que usam nossos assistentes virtuais veem resultados impressionantes",
      stats: {
        responseTime: {
          value: "90%",
    ...
    benefits: {
      ...
      subtitle: "Descubra como nossa tecnologia pode transformar seu negócio",
      items: {
        automation: {
          title: "Automação Inteligente",
          description: "Respostas automáticas 24/7 com inteligência artificial avançada"
        },
        integration: {
          title: "Integração Simples",
          description: "Configure em minutos e integre com suas ferramentas existentes"
        },
        analytics: {
          title: "Análises Detalhadas",
          description: "Relatórios completos para otimizar seu atendimento"
        }
      },
      fastImplementation: {
        title: "Implementação Rápida",
        description: "Setup completo em menos de 24 horas com suporte especializado"
      },
      totalSecurity: {
      ...
      specializedSupport: {
        ...
        description: "Equipe técnica dedicada disponível 24/7 para auxiliar seu negócio"
      },
      provenROI: {
    ...
    pricing: {
      ...
      importantInfo: {
        ...
        points: [
          ...
          "Cancelamento pode ser feito a qualquer momento, sem multa ou fidelidade.",
          "Ao contratar, você concorda com nossos Termos de Uso e Política de Privacidade.",
          "Valores podem sofrer reajuste anual conforme índices de inflação.",
          "Suporte técnico incluso em todos os planos durante horário comercial."
        ]
      }
    },
    cta: {
      title: "Pronto para Transformar Seu Atendimento?",
      subtitle: "Junte-se a milhares de empresas que já automatizaram seu WhatsApp",
      button: "Comece Agora",
      trial: "Teste grátis por 7 dias",
      startNow: "Começar Agora"
    },
    footer: {
      description: "Transformando o atendimento ao cliente com inteligência artificial.",
      product: "Produto",
    ...
    features: {
      ...
      subtitle: "Descubra tudo que nossos assistentes podem fazer pelo seu negócio",
      clickForDetails: "Clique para ver detalhes",
      talkToElli: "Falar com Elli sobre isso",
      features: {
        autoResponse: {
    ...
    privacyPolicy: {
      ...
      sections: {
        introduction: {
          title: "1. Introdução",
          content: "Esta Política de Privacidade descreve como a Opus coleta, usa e protege suas informações pessoais."
        },
        dataCollection: {
          title: "2. Coleta de Dados",
          content: "Coletamos informações que você nos fornece diretamente e dados de uso automáticos."
        },
        dataUse: {
          title: "3. Uso dos Dados",
          content: "Utilizamos seus dados para fornecer e melhorar nossos serviços."
        },
        dataProtection: {
        ...
        contact: {
          title: "5. Contato",
          content: "Para questões sobre privacidade, entre em contato conosco."
        }
      }
    },
    termsOfUse: {
      ...
      sections: {
        ...
        services: {
          ...
          content: "Fornecemos assistentes virtuais para WhatsApp com IA."
        },
        responsibilities: {
          title: "3. Responsabilidades do Usuário",
          content: "Você é responsável pelo uso apropriado dos serviços."
        },
        limitations: {
          title: "4. Limitações",
          content: "Nossos serviços são fornecidos 'como estão'."
        },
        contact: {
          title: "5. Contato",
          content: "Para questões sobre os termos, entre em contato conosco."
        }
      }
    }
  };
